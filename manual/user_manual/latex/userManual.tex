...
\subsection{License}
WebPlotDigitizer is distributed under the GNU General Public License version 3 by Ankit Rohatgi. For the complete terms and conditions, please refer to \url{http://www.gnu.org/copyleft/gpl.html}
...
\includegraphics[width=\textwidth]{./figures/barInfo.png}
\caption{Instructions for calibrating bar chart axes.}
\end{subfigure}
\\
\vspace{5mm}
\begin{subfigure}[b]{0.6\textwidth}
\includegraphics[width=\textwidth]{./figures/barAlignment.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=2.2in]{./figures/gridRemoval.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=3.5in]{./figures/manageDatasets.png}
