...
<select id="auto-extract-algo-name" onchange="wpd.autoExtraction.changeAlgorithm();">
    ...
    <optgroup label="Histograms">
        <option value="histogramExtractor" disabled>Bar Extraction</option>
  </optgroup>
</select>
</p>
...
<p style="margin-left: 10px;margin-top: 5px;">
    ...
    <input type="button" value="Clear Points" style="width:80px;" onclick="wpd.acquireData.clearAll();"/>
...
<!-- popup windows go here -->
    ...
    <div class="popupheading">Measurement Data</div>
