...
<table>
    ...
    <tr><td align="right">X% </td><td>&nbsp; <input type="text" value="10" id="grid-horiz-perc" style="width: 40px;"/></td></tr>
    <tr><td align="right">Vertical </td><td><input type="checkbox" id="grid-vert-enable" checked/></td></tr>
    <tr><td align="right">Y% </td><td>&nbsp; <input type="text" value="10" id="grid-vert-perc" style="width: 40px;"/></td></tr>
</table>
<hr/>
<p align="center">
