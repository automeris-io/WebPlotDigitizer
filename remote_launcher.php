...
<meta name="Description" content="WebPlotDigitizer v3.9 (beta) - Web based tool to extract numerical data from plots and graph images."/>
...
<div class="wpd-menu">
    ...
    <div class="wpd-menu-dropdown">
        <ul>
            <li id="wpd-analyzemenu-distance" onclick="wpd.distanceMeasurement.start();">Distances</li>
            <li id="wpd-analyzemenu-angles" onclick="wpd.angleMeasurement.start();">Angles</li>
            <li id="wpd-analyzemenu-angles" onclick="wpd.openPathMeasurement.start();">Path Length</li>
            <li id="wpd-analyzemenu-angles" onclick="wpd.closedPathMeasurement.start();">Area &amp; Circumference</li>
        </ul>
    </div>
</div>
<div class="wpd-menu">
...
<!-- popup windows go here -->
	...
	<p>&nbsp;</p>
    <p align="center">Version 3.9 (beta)</p>
