...
<meta name="Description" content="WebPlotDigitizer v3.7 (beta) - Web based tool to extract numerical data from plots and graph images."/>
...
<!-- popup windows go here -->
    ...
    <div id="barAxesInfo" class="popup" style="width: 350px;">
    <div class="popupheading">Align Bar Chart Axes</div>
    <p>&nbsp;</p>
    <p align="center"><img src="images/barchart.png" /></p>
    <p align="center">Click on two known points (Y1, Y2) on the continuous axes along the bars</p>
    <p>&nbsp;</p>
	...
	<p>&nbsp;</p>
    <p align="center">Version 3.7 (beta)</p>
