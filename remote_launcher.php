...
<p><input type="button" value="View Keyboard Shortcuts" onclick="wpd.popup.show('adjust-data-points-keyboard-shortcuts-window');"/></p>
             ...
             <div style="display:inline-block; position: absolute; top: 4px; right: 290px;" >
                <input type="button" title="Zoom in" value="+" onclick="wpd.graphicsWidget.zoomIn();" style="border:none; width:20px;"/>
                <input type="button" title="Zoom out" value="-" onclick="wpd.graphicsWidget.zoomOut();" style="border:none; width:20px;"/>
                <input type="button" title="View actual size" value="100%" onclick="wpd.graphicsWidget.zoom100perc();" style="border:none;"/>
                <input type="button" title="Fit to graphics area" value="Fit" onclick="wpd.graphicsWidget.zoomFit();" style="border:none;"/>
            </div>
