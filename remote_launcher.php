...
<meta name="Description" content="WebPlotDigitizer v3.8 (beta) - Web based tool to extract numerical data from plots and graph images."/>
...
<p><input type="button" value="View Keyboard Shortcuts" onclick="wpd.popup.show('adjust-data-points-keyboard-shortcuts-window');"/></p>
             ...
             <div style="display:inline-block; position: absolute; top: 4px; right: 290px;" >
                <input type="button" title="Zoom in" value="+" onclick="wpd.graphicsWidget.zoomIn();" style="width:20px;"/>
                <input type="button" title="Zoom out" value="-" onclick="wpd.graphicsWidget.zoomOut();" style="width:20px;"/>
                <input type="button" title="View actual size" value="100%" onclick="wpd.graphicsWidget.zoom100perc();"/>
                <input type="button" title="Fit to graphics area" value="Fit" onclick="wpd.graphicsWidget.zoomFit();"/>
            </div>
...
<p>
    ...
    <input id="clearAllBtn" type="button" value="Clear Points" onCLick="wpd.acquireData.clearAll();" style="width: 115px;"></p>
<div class="vertical-spacer"></div>
<p><input type="button" value="View Data" id="saveBtn" onclick="wpd.dataTable.showTable();" style="width:115px;"></p>
<div class="vertical-spacer"></div>
...
<p style="margin-left: 10px;margin-top: 5px;">
    <input type="button" value="Run" style="width:50px;" onclick="wpd.algoManager.run();"/>
...
<p>
    ...
    <input type="button" value="View Data" style="width: 100px;" id="view-measurement-data-button" onclick="wpd.dataTable.showDistanceData();"/>
</p>
</div>
...
<p>
    ...
    <input type="button" value="View Data" style="width: 110px;" onclick="wpd.dataTable.showAngleData();"/>
</p>
</div>
...
<!-- popup windows go here -->
	...
	<p>&nbsp;</p>
    <p align="center">Version 3.8 (beta)</p>
    ...
    <div id="adjust-data-points-keyboard-shortcuts-window" class="popup" style="width:350px;">
